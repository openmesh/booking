...
// The BookingMetadatumFunc type is an adapter to allow the use of ordinary
// function as BookingMetadatum mutator.
type BookingMetadatumFunc func(context.Context, *ent.BookingMetadatumMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f BookingMetadatumFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.BookingMetadatumMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.BookingMetadatumMutation", m)
	}
	return f(ctx, mv)
}
...
// The UnavailabilityFunc type is an adapter to allow the use of ordinary
// function as Unavailability mutator.
type UnavailabilityFunc func(context.Context, *ent.UnavailabilityMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UnavailabilityFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.UnavailabilityMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UnavailabilityMutation", m)
	}
	return f(ctx, mv)
}
